...
Done for the CE9010 Data Science class in my last semester at NTU. First foray into supervised classification through the basic Kaggle Titanic challenge

<br>
<br>

## Local Python installation if not yet done.
<br>
